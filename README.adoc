...
--   
* Ask your code communities and workplace to switch to an alternative or officially support a mirror. If that cannot be done, ask your code communities and workplace to at least allow additions to the community from these alternative.
