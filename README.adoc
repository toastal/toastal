...
* The API of GitHub is [not very stable](https://github.com/MichaelMure/git-bug/issues/749#issuecomment-1072991272). So while you can tool your way around simple things like email, it is not as simple with GitHub.
